...
public class PublicAPI {
    ...
    public List<XmlDTO> search(String keyword, String contentType, String page, String areaCode) throws IOException{
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=GAq%2FZB5kc5wlNPZMsjtHfPB6izN69ipO4dK9aeKKo0T4HhRRQPBujUTzEq04ST6q9k1NRfZq5slimpPTghrD7w%3D%3D"); /*Service Key*/
        urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("GAq%2FZB5kc5wlNPZMsjtHfPB6izN69ipO4dK9aeKKo0T4HhRRQPBujUTzEq04ST6q9k1NRfZq5slimpPTghrD7w%3D%3D", "UTF-8")); /*공공데이터에서 발급받은 인증키*/
    ...
    public XmlDTO detail(String content_id, String contentType) throws IOException{
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=GAq%2FZB5kc5wlNPZMsjtHfPB6izN69ipO4dK9aeKKo0T4HhRRQPBujUTzEq04ST6q9k1NRfZq5slimpPTghrD7w%3D%3D"); /*Service Key*/
        urlBuilder.append("&" + URLEncoder.encode("ServiceKey","UTF-8") + "=" + URLEncoder.encode("GAq%2FZB5kc5wlNPZMsjtHfPB6izN69ipO4dK9aeKKo0T4HhRRQPBujUTzEq04ST6q9k1NRfZq5slimpPTghrD7w%3D%3D", "UTF-8")); /*공공데이터포털에서*/
