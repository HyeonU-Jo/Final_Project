    ...
    public String index(Model model) {
        ...
        try{
            ...
            for(int i = 0; i<3; i++){
                ...
                xmlDTO.setContentType(xmlDTOS.get(i).getContentType());
                ...
                xmlDTO1.setContentType(xmlDTOS1.get(i).getContentType());
                ...
                xmlDTO2.setContentType(xmlDTOS2.get(i).getContentType());
